...
export class SpecManager {
    ...
    async create() {
        ...
        const terminal = await this.claudeProvider.invokeClaudeSplitView(prompt, 'Prisma - Creating Spec');
    ...
    async createWithAgents() {
        ...
        // Send to Claude and get the terminal
        const terminal = await this.claudeProvider.invokeClaudeSplitView(prompt, 'Prisma - Creating Spec (Agents)');
    ...
    async implTask(taskFilePath: string, taskDescription: string) {
        ...
        await this.claudeProvider.invokeClaudeSplitView(prompt, 'Prisma - Implementing Task');
    }
    ...
    async navigateToDocument(specName: string, type: SpecDocumentType) {
        ...
        try {
            ...
            const uniqueMarker = `<!-- prisma-spec: ${specName}/${type} -->`;
