...
export class PermissionWebview {
    ...
    public static createOrShow(
        ...
        if (outputChannel) {
            ...
            this.outputChannel = vscode.window.createOutputChannel('Prisma for Claude Code - Debug');
        }
                ...
                async message => {
                    switch (message.command) {
                        ...
                        case 'cancel':
                            ...
                            return;
                        case 'openIssue':
                            await vscode.env.openExternal(vscode.Uri.parse('https://github.com/matheusmaiberg/prisma/issues'));
                            return;
                    }
                },
                undefined,
