        ...
        while (!hasPermission) {
            ...
            if (retry === 'Try Again') {
                ...
                const confirm = await vscode.window.showWarningMessage(
                    'Are you sure you want to uninstall Prisma for Claude Code?',
                    'Keep It',
                    'Uninstall'
                );
