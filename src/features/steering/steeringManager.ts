...
export class SteeringManager {
    ...
    async createCustom() {
        ...
        try {
            ...
            await this.claudeCodeProvider.invokeClaudeSplitView(prompt, 'Prisma - Create Steering');
    ...
    */
    async init() {
        ...
        await vscode.window.withProgress({
            ...
            await this.claudeCodeProvider.invokeClaudeSplitView(prompt, 'Prisma - Init Steering');
    ...
    async refine(uri: vscode.Uri) {
        ...
        // Send to Claude
        await this.claudeCodeProvider.invokeClaudeSplitView(prompt, 'Prisma - Refine Steering');
