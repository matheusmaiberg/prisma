...
- ⚠️ Não valida path traversal automaticamente
- ⚠️ Zod valida tipos, mas não lógica de negócio

**Mitigação**: Pode ser adicionado depois se necessário (1-2 horas de trabalho).
...
- [ ] Criar YamlConfigLoader.ts (~200 linhas)
...
**Total**: **4-6 horas** (meio dia de trabalho).
