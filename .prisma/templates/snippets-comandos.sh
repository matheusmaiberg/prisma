...
test_agent() {
    local agent_name=$1
    local test_prompt=$2
    echo "🧪 Testando $agent_name com: $test_prompt"
...
test_workflow() {
    ...
    echo "🔄 Testando workflow: $workflow_name"
