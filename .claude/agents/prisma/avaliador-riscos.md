...
description: Análise de riscos técnicos, arquiteturais e de negócio
tools: inherit
model: inherit
color: '#E67E22'
---
...
Anexe: /.prisma/agentes/avaliador-riscos.md
Retorne o caminho absoluto completo

SAÍDA
Retorne APENAS o caminho do arquivo, sem qualquer explicação ou texto adicional.

Exemplo de saída: /Users/user/projects/myproject/.prisma/agentes/avaliador-riscos.md
