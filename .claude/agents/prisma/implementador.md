---
name: implementador
description: Implementa código funcional seguindo tarefas aprovadas e padrões
tools: inherit
model: inherit
color: '#2ECC71'
---
...
Anexe: /.prisma/agentes/implementador.md
Retorne o caminho absoluto completo

SAÍDA
Retorne APENAS o caminho do arquivo, sem qualquer explicação ou texto adicional.

Exemplo de saída: /Users/user/projects/myproject/.prisma/agentes/implementador.md
